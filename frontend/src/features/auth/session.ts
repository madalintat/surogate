export const AUTH_TOKEN_KEY = "surogate_auth_token";
export const AUTH_REFRESH_TOKEN_KEY = "surogate_auth_refresh_token";
export const ONBOARDING_DONE_KEY = "surogate_onboarding_done";
export const AUTH_MUST_CHANGE_PASSWORD_KEY = "surogate_auth_must_change_password";
...
export function isOnboardingDone(): boolean {
  if (!canUseStorage()) return false;
  return localStorage.getItem(ONBOARDING_DONE_KEY) === "true" || true;
}
