...
void rmsnorm_forward(float* out,
                     ...
                     int C,
                     cudaStream_t stream);
void rmsnorm_forward(nv_bfloat16* out,
                     float* rms,
...
void rmsnorm_apply_saved(float* out,
                         const float* inp,
                         const float* weight,
                         const float* rstd,
                         int B,
                         ...
                         int C,
                         cudaStream_t stream);
void rmsnorm_apply_saved(nv_bfloat16* out,
                         const nv_bfloat16* inp,
                         const nv_bfloat16* weight,
                         const float* rstd,
                         int B,
...
void rmsnorm_forward_quant(__nv_fp8_e4m3* out,
                           float* scale_ptr,
                           float* rms,
                           const nv_bfloat16* inp,
                           const nv_bfloat16* weight,
                           ...
                           int C,
                           cudaStream_t stream);
void rmsnorm_forward_quant(Tensor& out,
                           float* scale_ptr,
                           Tensor& rms,
                           const Tensor& inp,
                           const Tensor& weight,
...
void rmsnorm_backward(float* dinp,
                      float* dweight,
                      std::byte* scratch,
...
void rmsnorm_backward(nv_bfloat16* dinp,
                      nv_bfloat16* dweight,
                      std::byte* scratch,
                      const nv_bfloat16* dresidual,
                      const nv_bfloat16* dout,
                      const nv_bfloat16* inp,
                      const nv_bfloat16* weight,
                      const float* rstd,
...
void rmsnorm_backward_dweight_fp32(Tensor& dweight_fp32,
                                   const Tensor& dout,
                                   const Tensor& inp,
                                   const Tensor& rstd,
                                   int B,
...
void fused_residual_rmsnorm_forward(float* residual,
                                    float* normed,
                                    float* rrms,
                                    const float* inp1,
                                    const float* inp2,
...
void fused_residual_rmsnorm_forward(nv_bfloat16* residual,
                                    nv_bfloat16* normed,
                                    float* rrms,
                                    const nv_bfloat16* inp1,
                                    const nv_bfloat16* inp2,
                                    const nv_bfloat16* weight,
                                    float* abs_max_ptr,
                                    float epsilon,
                                    int N,
...
void fused_residual_rmsnorm_apply_saved(float* residual,
                                        float* normed,
                                        const float* inp1,
                                        const float* inp2,
                                        const float* weight,
                                        ...
                                        int C,
                                        cudaStream_t stream);
void fused_residual_rmsnorm_apply_saved(nv_bfloat16* residual,
                                        nv_bfloat16* normed,
                                        const nv_bfloat16* inp1,
                                        const nv_bfloat16* inp2,
                                        const nv_bfloat16* weight,
...
void swiglu_forward(nv_bfloat16* out,
                    const nv_bfloat16* inp,
                    float* abs_max_ptr,
                    int B,
                    int T,
...
void swiglu_forward_quant(__nv_fp8_e4m3* out,
                          float* scale_ptr,
                          const nv_bfloat16* inp,
                          const float* abs_max_ptr,
                          int B,
...
void swiglu_backward(nv_bfloat16* dinp,
                     const nv_bfloat16* dout,
                     const nv_bfloat16* inp,
                     float* abs_max,
                     int B,
                     ...
                     int C,
                     cudaStream_t stream);
void swiglu_backward(float* dinp,
                     const float* dout,
                     const float* inp,
                     float* abs_max,
                     int B,
...
void gpt_oss_moe_act_forward(nv_bfloat16* out,
                             ...
                             float limit,
                             cudaStream_t stream);
void gpt_oss_moe_act_forward(float* out, const float* inp, int N, int D, float alpha, float limit, cudaStream_t stream);
void gpt_oss_moe_act_backward(nv_bfloat16* dinp,
                              const nv_bfloat16* dout,
                              const nv_bfloat16* inp,
                              int N,
                              int D,
                              ...
                              float limit,
                              cudaStream_t stream);
void gpt_oss_moe_act_backward(float* dinp,
                              const float* dout,
                              const float* inp,
                              int N,
                              int D,
...
void quantize_with_abs_max(nv_bfloat16* out,
                           float* scale_ptr,
                           const float* in,
                           const float* abs_max,
                           long N,
                           const cudaDeviceProp& dp,
                           cudaStream_t stream);
void quantize_with_abs_max(std::int8_t* out,
                           float* scale_ptr,
                           const float* in,
                           const float* abs_max,
                           long N,
...
void quantize_with_abs_max(__nv_fp8_e4m3* out,
                           ...
                           const cudaDeviceProp& dp,
                           cudaStream_t stream);
void quantize_with_abs_max(__nv_fp8_e5m2* out,
                           float* scale_ptr,
                           const float* in,
                           const float* abs_max,
                           long N,
...
void quantize_and_transpose_with_abs_max(nv_bfloat16* out,
                                         float* scale_ptr,
                                         const float* in,
                                         const float* abs_max,
                                         int rows,
                                         ...
                                         const cudaDeviceProp& dp,
                                         cudaStream_t stream);
void quantize_and_transpose_with_abs_max(std::int8_t* out,
                                         float* scale_ptr,
                                         const float* in,
                                         const float* abs_max,
                                         int rows,
                                         ...
                                         const cudaDeviceProp& dp,
                                         cudaStream_t stream);
void quantize_and_transpose_with_abs_max(__nv_fp8_e4m3* out,
                                         float* scale_ptr,
                                         const float* in,
                                         const float* abs_max,
                                         int rows,
...
void quantize_and_transpose_with_abs_max(__nv_fp8_e4m3* out,
                                         ...
                                         const cudaDeviceProp& dp,
                                         cudaStream_t stream);
void quantize_and_transpose_with_abs_max(__nv_fp8_e5m2* out,
                                         float* scale_ptr,
                                         const float* in,
                                         const float* abs_max,
                                         int rows,
...
void quantize_with_delayed_scale(__nv_fp8_e4m3* out,
                                 float* recorded_amax,
                                 float* inv_scale_ptr,
                                 const nv_bfloat16* in,
                                 ...
                                 const cudaDeviceProp& dp,
                                 cudaStream_t stream);
void quantize_with_delayed_scale(__nv_fp8_e5m2* out,
                                 float* recorded_amax,
                                 float* inv_scale_ptr,
                                 const nv_bfloat16* in,
                                 const float* delayed_scale,
...
void vector_add_sr(float* dest,
                   ...
                   unsigned seed,
                   cudaStream_t stream);
void vector_add_sr(nv_bfloat16* dest,
...
void vector_reduce_sr(float* dest,
                      const float* src,
                      float scale,
                      int n_shards,
                      int skip,
                      ...
                      unsigned seed,
                      cudaStream_t stream);
void vector_reduce_sr(nv_bfloat16* dest,
                      const nv_bfloat16* src,
                      float scale,
                      int n_shards,
                      int skip,
...
void fused_bf16_accum_to_fp32_strided(float* out,
                                      const nv_bfloat16* src,
                                      int rows,
                                      int src_cols,
                                      int out_stride,
...
/// @param M Number of rows.
/// @param K Number of columns.
void quantize_mx_fp8_e4m3(__nv_fp8_e4m3* out_fp8,
                          uint8_t* mx_scales,
                          const nv_bfloat16* in,
                          int M,
                          int K,
...
void quantize_mx_fp8_e5m2(__nv_fp8_e5m2* out_fp8,
                          uint8_t* mx_scales,
                          const nv_bfloat16* in,
                          int M,
                          int K,
...
void dequantize_mx_fp8_e4m3(nv_bfloat16* out,
                            const __nv_fp8_e4m3* in_fp8,
                            const uint8_t* mx_scales,
                            int M,
                            int K,
                            const cudaDeviceProp& dp,
                            cudaStream_t stream);
...
void dequantize_mx_fp8_e5m2(nv_bfloat16* out,
                            const __nv_fp8_e5m2* in_fp8,
                            const uint8_t* mx_scales,
                            int M,
                            int K,
                            const cudaDeviceProp& dp,
...
void quantize_mx_fp8_weight(__nv_fp8_e4m3* out_fp8,
                            uint8_t* mx_scales,
                            const nv_bfloat16* in,
                            int N,
                            int K,
...
void quantize_mx_fp8_e4m3(Tensor& out_fp8,
                          Tensor& mx_scales,
                          const Tensor& in,
                          const cudaDeviceProp& dp,
                          cudaStream_t stream);
...
void quantize_mx_fp8_e5m2(Tensor& out_fp8,
                          Tensor& mx_scales,
                          const Tensor& in,
                          const cudaDeviceProp& dp,
                          cudaStream_t stream);
...
void dequantize_mx_fp8_e4m3(Tensor& out,
                            const Tensor& in_fp8,
                            const Tensor& mx_scales,
                            const cudaDeviceProp& dp,
                            cudaStream_t stream);

/// @brief Tensor-based MX FP8 E5M2 dequantization.
void dequantize_mx_fp8_e5m2(Tensor& out,
                            const Tensor& in_fp8,
                            const Tensor& mx_scales,
                            const cudaDeviceProp& dp,
                            cudaStream_t stream);
...
void quantize_mx_fp8_weight(Tensor& out_fp8,
                            Tensor& mx_scales,
                            const Tensor& in,
                            const cudaDeviceProp& dp,
                            cudaStream_t stream);
...
void dequantize_nvfp4_cutlass(nv_bfloat16* out,
                              const uint8_t* in_fp4,
...
void dequantize_nvfp4_cutlass(Tensor& out,
                              const Tensor& in_fp4,
                              const Tensor& block_scales,
                              const cudaDeviceProp& dp,
                              cudaStream_t stream);
...
void quantize_nvfp4_4o6_cutlass_auto_scale(uint8_t* out_fp4,
                                           uint8_t* block_scales,
                                           float* global_amax,
                                           const nv_bfloat16* in,
                                           int M,
...
void quantize_nvfp4_4o6_cutlass(Tensor& out_fp4,
                                Tensor& block_scales,
                                Tensor& global_amax,
                                const Tensor& in,
                                recipes::FourOverSixErrorMetric error_metric,
...
void quantize_nvfp4_4o6_stochastic_cutlass(Tensor& out_fp4,
                                           Tensor& block_scales,
                                           Tensor& global_amax,
                                           const Tensor& in,
                                           recipes::FourOverSixErrorMetric error_metric,
...
void matmul_cutlass_fp4(nv_bfloat16* c,
                        const uint8_t* a,
                        const uint8_t* b,
...
void matmul_cutlass_fp4_f32(float* c,
                            const uint8_t* a,
                            const uint8_t* b,
                            const uint8_t* scale_a,
                            const uint8_t* scale_b,
...
/// @param stream CUDA stream
void matmul_cutlass_fp4_alpha(nv_bfloat16* c,
                              const uint8_t* a,
                              const uint8_t* b,
                              const uint8_t* scale_a,
                              const uint8_t* scale_b,
...
/// @param dp CUDA device properties.
/// @param stream CUDA stream.
void quantize_bnb_nf4(unsigned char* out,
                      float* absmax,
                      const nv_bfloat16* in,
                      int M,
                      int K,
...
void quantize_bnb_nf4(Tensor& out,
                      Tensor& absmax,
                      const Tensor& in,
                      int block_size,
                      const cudaDeviceProp& dp,
...
/// @param dp CUDA device properties.
/// @param stream CUDA stream.
void dequantize_bnb_nf4(nv_bfloat16* out,
...
void dequantize_bnb_nf4(Tensor& out,
                        const Tensor& in,
                        const Tensor& absmax,
                        int block_size,
                        const cudaDeviceProp& dp,
...
/// @param dp CUDA device properties.
/// @param stream CUDA stream.
void quantize_absmax_double(unsigned char* out_quant,
                            float* out_scale,
                            float* out_offset,
                            const float* absmax,
                            int num_absmax,
...
/// @param dp CUDA device properties.
/// @param stream CUDA stream.
void dequantize_bnb_nf4_double(nv_bfloat16* out,
                               const unsigned char* in,
