...
#ifndef SUROGATE_SRC_UTILITIES_SOL_H
#define SUROGATE_SRC_UTILITIES_SOL_H
...
// Runs a large matmul to measure device peak flops in fp8
double measure_real_peak_fp8();

#endif // SUROGATE_SRC_UTILITIES_SOL_H
